...
@Component({
  ...
  template: `
    <aside #sidebar
      ...
      class="isidebar isidebar--{{opened ? 'opened' : 'closed'}} isidebar--{{position}} isidebar--{{mode}}"
      [class.isidebar--docked]="_isDocked"
      [class.isidebar--inert]="_isInert"
      [class.isidebar--animate]="animate"
...
export class ISidebar implements OnInit, OnChanges, OnDestroy {
  ...
  constructor(
    @Optional() private _container: ISidebarContainer,
    private _ref: ChangeDetectorRef,
    @Inject(PLATFORM_ID) platformId: Object) {
    if (!this._container) {
      throw new Error(
        '<isidebar> must be inside a <isidebar-container>. ' +
        'See https://github.com/arkon/isidebar#usage for more info.'
      );
    }
